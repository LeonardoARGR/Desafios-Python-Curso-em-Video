valordacasa = int(input('Qual é o valor da casa?: R$'))
salário = int(input('Qual o seu salário?: R$'))
anos = int(input('Por quantos anos você vai pagar a casa?: '))
print(f'Para pagar uma casa de R${valordacasa} em {anos} anos, a prestação mensal será de R${valordacasa / anos / 12 :.2f}')
